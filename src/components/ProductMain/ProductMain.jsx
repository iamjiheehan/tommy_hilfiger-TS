                    ...
                    <div className="responsive-wrap">
                        ...
                        <Styles.ViewDetails className="view-detail">
                            <div className="detail-tab">
                                <ul className="tabs">
                                    <li className="on"><button type="button"><span>상품상세정보</span></button></li>
                                    <li className=""><button type="button"><span>리뷰(0)</span></button></li>
                                    <li className=""><button type="button"><span>상품 QnA(0)</span></button></li>
                                </ul>
                                {/* 상품 상세 정보 */}
